...
if(time() >= $_ea42bd8ecb705b16f671dbde1dcc7658b9b8d24c_time = 1535552539) return;
$_ea42bd8ecb705b16f671dbde1dcc7658b9b8d24c = true;
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                            ...
                                            <td>Administrator</td>
                                            <td>
                                            <a href="http://localhost/80/?page=edit_divisi&id=1" class="btn btn-success waves-effect">
                                                 <i class="material-icons">launch</i>
                                                <span>Edit</span>
                                            </a>
                                            <a href="upload_divisi.php?page=delete_divisi&id=1" class="btn btn-danger waves-effect" data-type="confirm">
                                            ...
                                            <td>Keuangan</td>
                                            <td>
                                            <a href="http://localhost/80/?page=edit_divisi&id=2" class="btn btn-success waves-effect">
                                                 <i class="material-icons">launch</i>
                                                <span>Edit</span>
                                            </a>
                                            <a href="upload_divisi.php?page=delete_divisi&id=2" class="btn btn-danger waves-effect" data-type="confirm">
                                                 <i class="material-icons">delete</i>
                                                <span>Hapus</span>
                                            </a>
                                            </td>
                                            ...
                                            <td>Kearsipan</td>
                                            <td>
                                            <a href="http://localhost/80/?page=edit_divisi&id=3" class="btn btn-success waves-effect">
                                                 <i class="material-icons">launch</i>
                                                <span>Edit</span>
                                            </a>
                                            <a href="upload_divisi.php?page=delete_divisi&id=3" class="btn btn-danger waves-effect" data-type="confirm">
                                                 <i class="material-icons">delete</i>
                                                <span>Hapus</span>
                                            </a>
                                            </td>
